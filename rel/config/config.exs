...
config :remedy,
  canonical_host: host,
  force_ssl: force_ssl,
  ecto_repos: [Remedy.Repo]

# Configure Phoenix
config :phoenix, :json_library, Jason

# Configure Repo with Postgres
config :remedy, Remedy.Repo,
...
config :remedy, RemedyWeb.Endpoint,
  ...
  pubsub: [name: Remedy.PubSub, adapter: Phoenix.PubSub.PG2],
  render_errors: [view: RemedyWeb.Errors.View, accepts: ~w(html json)]

# Configure Gettext
config :remedy, Remedy.Gettext, default_locale: "en"
